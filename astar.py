...
def main(window, width):
	...
	print("### A* Algorithm Instructions ###")
	print("### 1: Select a start and end node ###")
	print("### 2: Select as many obstacles to the path as you wish ###")
	print("### RIGHT-CLICK ON CUBES TO RESET THEM ###")
	print("### 3: Hit the SPACE bar to begin Pathfinding ###")
	start = None
	end = None
